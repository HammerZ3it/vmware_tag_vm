...
# Use example : tag-operation [tag|untag] [tag_id] [vm_name]

tag_op = sys.argv[1]
tag_id = sys.argv[2]
vm_name = sys.argv[3]

vcenter_server = 'your.vcenter.adress'
...
"""
Create an authenticated stub configuration used to issue requests with vCenter.
Returns a stub_config.
"""
